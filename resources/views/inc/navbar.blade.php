  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="{{url('/')}}" class="navbar-brand">
        <img src="{{asset('uploads/initial/logo.png')}}" alt="Nepdoor Logo" class="brand-image elevation-3 p-2" style="height:40px;width:110px;">
      </a>
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Training</a>
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              <li><a href="#" class="dropdown-item">Certified Digital Marketing Professional Course</a></li>
        ...
        <ul class="navbar-nav ml-3">
            <li class="nav-item">
              <a name="" id="" class="btn btn-primary" href="{{url('subscribe')}}" role="button">Subscribe Now</a>
            </li>
          </ul>
      </div>
