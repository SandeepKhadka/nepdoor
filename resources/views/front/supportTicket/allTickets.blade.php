        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-sm">
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <h1 class="m-0 text-center"><span style="color: #2151A1; font-weight: bold ">ALL</span><span
                                        ...
                                        <div class="col-lg-9">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <textarea type="number" id="amount" name="amount" class="form-control w-100 px-3 py-3" rows="2"
                                                        style="resize: none ;background-color: #e7e7e9; border-radius:15px 12px 0px 15px; color: rgb(0, 0, 0); font-size:12px"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
