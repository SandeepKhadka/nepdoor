  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-center font-weight-bold">Search Engine Optimization(SEO) Professional Training</small></h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="content-header">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12">
                        <h1 class="m-0 text-center font-weight-bold">SEO Training</small></h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                </div>
