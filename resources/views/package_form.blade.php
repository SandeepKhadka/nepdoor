    ...
    <div class="wrapper">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="digitalMarketing">{{$category_title}}</li>
            </ol>
        </nav>
        @include('inc.sidebar')
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <h1 class="m-0 text-center font-weight-bold">{{$category_title}}</small></h1>
                        </div><!-- /.col -->
                    </div>
                </div>
            </div>
                                                ...
                                                <select id="package_id" name="package_id" required
                                                    ...
                                                    @if (isset($package_info))
                                                        @foreach ($package_info as $package)
                                                            @if ($package->cat_info['title'] == $category_title)
                                    ...
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="info-box">
                                            <div class="info-box-content">
                                                ...
                                                <a href="{{$package->link}}" class="card-link" target="new">Learn More</a>
                                            </div>
                                            <!-- /.info-box-content -->
                                        </div>
                                        <!-- /.info-box -->
