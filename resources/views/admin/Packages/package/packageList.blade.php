            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="margin-top: 8px">Packages</h3>
                        <a href="{{ url('packageForm') }}" class="btn btn-primary" style="margin-left:949px;";>
                            Add
                        </a>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="#"><button class="btn btn-danger" style="margin-right: 10px"><i
                                        ...
                                        <a href="{{ url('packageView') }}"><button class="btn btn-primary" style="margin-right: 10px"><i
                                                    class="fa fa-eye"></button></i></a>
                                        <a href="{{ url('packageForm') }}"><button class="btn btn-success"style="margin-right: 10px"><i
