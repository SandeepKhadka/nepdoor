                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="subs_id" name="subs_id" class="form-control"
                                        value="{{ @$ticket_data->subs_id }}">
                                    @error('subs_id')
                                        <span class="alert-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <select type="text" class="form-control form-control-sm" id="priority"
                                        name="priority" name="priority" required>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select type="text" class="form-control form-control-sm" id="ticket_status"
                                            name="ticket_status" value="{{ @$ticket_data->ticket_status }}" required
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select type="text" class="form-control form-control-sm" id="status"
                                            name="status" required value="{{ @$ticket_data->status }}" name="status"
                                            required>
