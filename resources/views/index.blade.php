  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-center font-weight-bold"> Get Free Consulting</small></h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="subject" name="subject" class="form-control custom-select">
                                    ...
                                    <option>SEO</option>
                                    <option>Digital Marketing & SEO Training</option>
                                    <option>Other</option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="content-header">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12">
                        <h1 class="m-0 text-center font-weight-bold"> Subscribe our basic package instantly !</small></h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                </div>
                ...
                <div class="content-header">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12">
                        <h1 class="m-0 text-center font-weight-bold">Social Media Marketing Packages</small></h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                </div>
                ...
                <div class="content-header">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12">
                        <h1 class="m-0 text-center font-weight-bold">Digital Marketing & SEO Training</small></h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                </div>
