...
@section('main-content')
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="m-0 text-left font-weight-bold" style="padding: 10px">Subscription Form</small></h4>
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label for="inputName">Billing ID</label>
                                    <input type="number" id="inputName" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea type="number" id="inputName" class="form-control" rows="5"></textarea>
                                </div>
                            </div>
                            ...
                            <a href="{{ url('subscriptionList') }}"><button type="submit" class="btn btn-primary float-right" style="margin-right: 10px" value="Back">Back</button></a>
                        </div>
                    </div>
